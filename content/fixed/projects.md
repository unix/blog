...
- [cfunc](https://github.com/unix/cfunc) 使用 func 构建的 func 脚手架
...
- [done](https://github.com/unix/done) - 比 release2 好那么一点
...
- [koa2-typescript-guide](https://github.com/unix/koa2-typescript-guide) - Koa2 与 TS 的最佳实践，包含脚手架
...
- [now-coffee](https://github.com/unix/now-coffee) Now 的 coffeescript 编译过程，贡献在 now 的 [Examples project](https://github.com/zeit/now-examples/blob/master/nodejs-coffee/now.json)。
...
- [Nioro](https://github.com/unix/Nioro) 魔兽世界 Lua 插件，框架界面增强，[用户量>6k](https://www.curseforge.com/wow/addons/Nioro)
